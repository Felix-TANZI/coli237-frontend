...
export function BoutonGps({
  ...
  return (
    <div className="mb-4">
      ...
      >
        <div
          className={`w-9 h-9 rounded-lg flex items-center justify-center ${position ? "bg-coli-vert text-white" : "bg-gray-100 text-gray-500"}`}
        >
          <i
            className={`ti ${enCours ? "ti-loader-2 animate-spin" : position ? "ti-map-pin-check" : "ti-map-pin"} text-lg`}
          />
        </div>
