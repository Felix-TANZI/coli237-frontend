...
export const MARQUES_MOTO = [
  'Sanili', 'Nasco', 'Kymco', 'Sanya', 'Haojue', 'Boxer',
  'Royal', 'Jincheng', 'Skygo', 'Honda', 'Yamaha', 'Suzuki',
  'Apsonic', 'TVS', 'Bajaj',
];

export const MARQUES_VOITURE = [
  'Toyota', 'Nissan', 'Hyundai', 'Kia', 'Mercedes', 'Volkswagen',
  'Peugeot', 'Renault', 'Ford', 'Mitsubishi', 'Honda', 'Suzuki',
];

// Principales villes du Cameroun.
export const VILLES_CAMEROUN = [
  'Yaoundé', 'Douala', 'Bafoussam', 'Bamenda', 'Buea', 'Garoua',
  'Maroua', 'Ngaoundéré', 'Bertoua', 'Ebolowa', 'Kribi', 'Limbé',
  'Édéa', 'Kumba', 'Nkongsamba', 'Dschang', 'Foumban',
];
...
export const QUARTIERS_PAR_VILLE: Record<string, string[]> = {
  Yaoundé: [
    'Mvog-Ada', 'Bastos', 'Mvan', 'Biyem-Assi', 'Nsam', 'Mokolo',
    'Essos', 'Nlongkak', 'Emombo', 'Mendong', 'Etoudi', 'Ekounou',
    'Nkolbisson', 'Obili', 'Mimboman',
  ],
  Douala: [
    'Akwa', 'Bonabéri', 'Bonanjo', 'Deido', 'New Bell', 'Bépanda',
    'Makepe', 'Bonamoussadi', 'Ndokotti', 'Logbaba', 'PK', 'Bali',
    'Yassa', 'Village',
  ],
