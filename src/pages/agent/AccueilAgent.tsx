    ...
    <div className="min-h-screen bg-coli-craie pb-24 md:pb-0">
      ...
      <div className="max-w-md md:max-w-5xl mx-auto md:px-6 md:py-6">
        ...
        <div className="px-4 md:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_320px] gap-3 mt-4">
            <button
              onClick={() => navigate('/agent/recenser')}
              ...
              style={{
                background: 'linear-gradient(135deg,#1FB89E,#0F6E56)',
            ...
            >
              ...
              <div>
                <div className="font-semibold text-sm md:text-base">
                  {t('agent.nouveauRecensement')}
                </div>
                <div className="text-[11px] text-white/75 mt-0.5">
                  {t('agent.coursierOuEntreprise')}
                </div>
              </div>
            </button>
            ...
            {/* Rythme hebdo */}
            <div
              className="ag-anim ag-d3 bg-white rounded-2xl border border-gray-200/70 p-4"
