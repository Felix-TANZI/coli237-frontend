  ...
  return (
    <div className="min-h-screen bg-coli-craie pb-24 md:pb-0">
      ...
      <div className="max-w-2xl mx-auto px-4 py-5 md:px-6 md:py-6">
        ...
        {/* Activité */}
        <div
          className="bg-white rounded-2xl border border-gray-200/70 p-5 mb-4"
          style={{ boxShadow: OMBRE }}
        >
          <div className="text-sm font-semibold text-coli-encre mb-3">
            {t("profil.monActivite")}
          </div>
          <div className="grid grid-cols-3 gap-3">
            <Stat
              valeur={data?.recenses ?? 0}
              label={t("profil.recenses")}
              couleur="#1FB89E"
            />
            <Stat
              valeur={data?.valides ?? 0}
              label={t("profil.valides")}
              couleur="#17A2B8"
            />
            <Stat
              valeur={data?.attente ?? 0}
              label={t("profil.enAttente")}
              couleur="#F28C28"
            />
          </div>
        </div>
        ...
        >
          ...
          <Ligne
            icone="ti-phone"
            label={t("profil.telephone")}
            valeur={moi?.telephone ?? "—"}
          />
        </div>
