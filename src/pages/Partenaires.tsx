        ...
        <div className="hidden md:block bg-white rounded-2xl border border-gray-100 overflow-hidden">
          ...
          {filtres.map((p) => {
            ...
            return (
              <div
                key={p.id}
                className="grid grid-cols-[2fr_1.5fr_1fr_1fr_1.3fr] px-5 py-3 items-center border-b border-gray-50 last:border-none hover:bg-gray-50/50 transition"
              >
                  ...
                  {p.statut === "EN_ATTENTE" && (
                    <>
                      <button
                        ...
                        aria-label={t("partenaires.valider")}
                      ...
                      <button
                        onClick={() => rejeter.mutate(p.id)}
                        disabled={rejeter.isPending}
                        aria-label={t("partenaires.rejeter")}
